...
/* #include <SPIFF.h>              // also needed, but already included in Main.ino */
...
#define GAIN_BOOSTER_I2S        15     // original I2S streams is VERY silent, so we added an optional GAIN booster for INMP441
...
bool Record_Start( String audio_filename ) 
{
  ...
  { 
    ...
    // Save audio data to SPIFF card (appending chunk array to file end)
